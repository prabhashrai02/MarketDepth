...
const AppContent = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-slate-100 font-sans">
      <div className="mx-auto px-3 py-5 sm:py-8 lg:py-10 w-full max-w-[98vw] sm:max-w-[92vw] lg:max-w-[1180px]">
        <header className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-cyan-200/80 max-w-3xl">
            Real-time order book aggregation from Polymarket and Kalshi with unified overlays, spread analytics, and smart routing insights.
          </p>
        </header>
        ...
        <footer
          className="mt-8 sm:mt-12 text-center text-xs sm:text-sm text-slate-400"
        >
